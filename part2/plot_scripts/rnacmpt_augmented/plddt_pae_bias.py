...
plt.ylabel("plDDT")
plt.xlabel("Dataset")
plt.savefig("plots/plddt_pae_bias_plot1.pdf")
# plt.show()
...
plt.savefig("plots/plddt_pae_bias_plot2.pdf")
# plt.show()
...
# Save and show
plt.savefig("plots/plddt_pae_bias_plot3_split_contours_enhanced.png")
# plt.show()
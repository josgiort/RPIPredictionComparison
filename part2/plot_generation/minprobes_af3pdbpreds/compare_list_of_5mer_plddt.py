...
plt.savefig("plddt_distr_rna_prot_alt.pdf")
plt.show()
...
plt.title("Mean RNA plDDT vs. Mean Protein plDDT (Per 3-mer Pair) - alternative dataset (Positives only)")
plt.axline((0, 0), slope=1, color="red", linestyle="dashed")  # y = x reference line
plt.savefig("comparison_list_of_3mer_mean_plddt_alt.pdf")
plt.show()
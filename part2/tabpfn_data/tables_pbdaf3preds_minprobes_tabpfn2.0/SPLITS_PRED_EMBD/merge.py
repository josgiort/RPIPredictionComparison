...
#
# # File paths
# big_csv_path = "AA_split_uniprot_277_features_train_no_kmer.csv"
# small_csv_path = "AA_split_uniprot_28_features_train_full.csv"
...
#     how="inner"  # Change to 'inner' if you want only matches
# )
#

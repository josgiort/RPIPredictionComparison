...
main_csv_path = "split_uniprot_277_features_train_seq.csv"
predictions_csv_path = "1mer_table_minprobes_pdbaf3preds_merged_SEQ_INFO_PREDS_EMBEDOR_filtered.csv"
output_csv_path = "split_uniprot_277_features_train_seq.csv"

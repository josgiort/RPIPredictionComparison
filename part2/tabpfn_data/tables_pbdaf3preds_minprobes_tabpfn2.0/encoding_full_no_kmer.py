...
# Load dataset
df = pd.read_csv("split_uniprot_277_features_train_no_kmer.csv")  # Replace with your actual dataset file

# --- 🔹 Drop Unnecessary Columns ---
df = df.drop(columns=["gc", "rna_length"], errors="ignore")
...
df.to_csv("split_uniprot_277_features_train_no_kmer.csv", index=False)

...
# Load dataset
df = pd.read_csv("split_uniprot_277_features_train_seq.csv")  # Replace with your actual dataset file
...
df.to_csv("split_uniprot_277_features_train_seq.csv", index=False)

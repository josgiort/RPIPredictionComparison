...
# Load dataset
df = pd.read_csv("split_random_277_features_test_full.csv")  # Replace with your actual dataset file
...
df.to_csv("split_random_277_features_test_full.csv", index=False)

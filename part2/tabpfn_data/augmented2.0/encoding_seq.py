...
# Load dataset
df = pd.read_csv("split_rbp_name_278_features_train_seq.csv")  # Replace with your actual dataset file
...
df = df.drop(columns=["prot_seq", "rna_seq"], errors="ignore")

# Save the processed dataset
df.to_csv("split_rbp_name_278_features_train_seq.csv", index=False)

...
from convert_to_csv import convert_txt_to_csv
from scatter_plot_from_csv import plot_rna_len_vs_pred_prob
...
output_file = run_inference(output_file)

csv = convert_txt_to_csv(output_file, output_file.split(".")[0] + ".csv")

scatter = plot_rna_len_vs_pred_prob(output_file.split(".")[0] + ".csv")
